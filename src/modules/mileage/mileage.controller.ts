...
export class MileageController {
  ...
  /**
   * Queue listener for Mileage
   */
  @MsListener(`controller.${entity}`)
  async execute(job: Job): Promise<void> {
    job = new Job(job);
    await this.mileageService[job.action]<JobResponse>(job);
  ...
  async create(
    ...
    const { error, data } = await this.mileageService.create(
      new Job({
        owner,
        action: 'create',
        body: createMileageDto,
      }),
    );
  ...
  async update(
    ...
    const { error, data } = await this.mileageService.update(
      new Job({
        owner,
        action: 'update',
        id: +id,
        body: updateMileageDto,
      }),
    );
  ...
  async findAll(
    ...
    const { error, data, offset, limit, count } =
      await this.mileageService.findAll(
        new Job({
          owner,
          action: 'findAll',
          options: { ...query },
  ...
  async countAll(
    ...
    const { error, count } = await this.mileageService.getCount(
      new Job({
        owner,
        action: 'getCount',
        options: { ...query },
  ...
  async findOne(
    ...
    const { error, data } = await this.mileageService.findOne(
      new Job({
        owner,
        action: 'findOne',
        options: { ...query },
  ...
  async findById(
    ...
    const { error, data } = await this.mileageService.findById(
      new Job({
        owner,
        action: 'findById',
        id: +id,
  ...
  async delete(
    ...
    const { error, data } = await this.mileageService.delete(
      new Job({
        owner,
        action: 'delete',
        id: +id,
